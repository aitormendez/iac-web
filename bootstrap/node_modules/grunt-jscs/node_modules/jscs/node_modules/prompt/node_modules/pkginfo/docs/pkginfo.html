...
<span class=kd>var</span> <span class=nx>fs</span> <span class=o>=</span> <span class=nx>require</span><span class=p>(</span><span class=s1>&#39;fs&#39;</span><span class=p>),</span>
  ...
  <span class=p>});</span>
  </pre></div> </td> </tr> <tr id=section-3> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-3>&#182;</a> </div> <p><strong>Parse variable arguments</strong></p> </td> <td class=code> <div class=highlight><pre>  <span class=k>if</span> <span class=p>(</span><span class=nb>Array</span><span class=p>.</span><span class=nx>isArray</span><span class=p>(</span><span class=nx>options</span><span class=p>))</span> <span class=p>{</span></pre></div> </td> </tr> <tr id=section-4> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-4>&#182;</a> </div> <p>If the options passed in is an Array assume that it is the Array of properties to expose from the on the package.json file on the parent module.</p> </td> <td class=code> <div class=highlight><pre>    <span class=nx>options</span> <span class=o>=</span> <span class=p>{</span> <span class=nx>include</span><span class=o>:</span> <span class=nx>options</span> <span class=p>};</span>
  <span class=p>}</span>
  <span class=k>else</span> <span class=k>if</span> <span class=p>(</span><span class=k>typeof</span> <span class=nx>options</span> <span class=o>===</span> <span class=s1>&#39;string&#39;</span><span class=p>)</span> <span class=p>{</span></pre></div> </td> </tr> <tr id=section-5> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-5>&#182;</a> </div> <p>Otherwise if the first argument is a string, then assume that it is the first property to expose from the package.json file on the parent module.</p> </td> <td class=code> <div class=highlight><pre>    <span class=nx>options</span> <span class=o>=</span> <span class=p>{</span> <span class=nx>include</span><span class=o>:</span> <span class=p>[</span><span class=nx>options</span><span class=p>]</span> <span class=p>};</span>
  <span class=p>}</span>
  ...
  <span class=k>if</span> <span class=p>(</span><span class=nx>args</span><span class=p>.</span><span class=nx>length</span> <span class=o>&gt;</span> <span class=mi>0</span><span class=p>)</span> <span class=p>{</span></pre></div> </td> </tr> <tr id=section-7> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-7>&#182;</a> </div> <p>If additional string arguments have been passed in then add them to the properties to expose on the parent module. </p> </td> <td class=code> <div class=highlight><pre>    <span class=nx>options</span><span class=p>.</span><span class=nx>include</span> <span class=o>=</span> <span class=nx>options</span><span class=p>.</span><span class=nx>include</span><span class=p>.</span><span class=nx>concat</span><span class=p>(</span><span class=nx>args</span><span class=p>);</span>
  <span class=p>}</span>
...
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-8> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-8>&#182;</a> </div> <h3>function find (dir)</h3> <h4>@pmodule {Module} Parent module to read from.</h4> <h4>@dir {string} <strong>Optional</strong> Directory to start search from.</h4> <p>Searches up the directory tree from <code>dir</code> until it finds a directory which contains a <code>package.json</code> file. </p> </td> <td class=code> <div class=highlight><pre><span class=nx>pkginfo</span><span class=p>.</span><span class=nx>find</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>(</span><span class=nx>pmodule</span><span class=p>,</span> <span class=nx>dir</span><span class=p>)</span> <span class=p>{</span>
