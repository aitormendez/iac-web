...
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-6> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-6>&#182;</a> </div> <h3>function pause ()</h3> <p>Pauses input coming in from stdin</p> </td> <td class=code> <div class=highlight><pre><span class=nx>prompt</span><span class=p>.</span><span class=nx>pause</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>()</span> <span class=p>{</span>
  ...
  <span class=k>return</span> <span class=nx>prompt</span><span class=p>;</span>
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-7> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-7>&#182;</a> </div> <h3>function resume ()</h3> <p>Resumes input coming in from stdin </p> </td> <td class=code> <div class=highlight><pre><span class=nx>prompt</span><span class=p>.</span><span class=nx>resume</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>()</span> <span class=p>{</span>
...
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-8> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-8>&#182;</a> </div> <h3>function get (msg, [validator,] callback)</h3> <h4>@msg {Array|Object|string} Set of variables to get input for.</h4> <h4>@callback {function} Continuation to pass control to when complete.</h4> <p>Gets input from the user via stdin for the specified message(s) <code>msg</code>.</p> </td> <td class=code> <div class=highlight><pre><span class=nx>prompt</span><span class=p>.</span><span class=nx>get</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>(</span><span class=nx>msg</span><span class=p>,</span> <span class=nx>callback</span><span class=p>)</span> <span class=p>{</span>
  ...
  <span class=k>return</span> <span class=nx>prompt</span><span class=p>;</span>
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-9> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-9>&#182;</a> </div> <h3>function getInput (msg, validator, callback)</h3> <h4>@msg {Object|string} Variable to get input for.</h4> <h4>@callback {function} Continuation to pass control to when complete.</h4> <p>Gets input from the user via stdin for the specified message <code>msg</code>.</p> </td> <td class=code> <div class=highlight><pre><span class=nx>prompt</span><span class=p>.</span><span class=nx>getInput</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>(</span><span class=nx>prop</span><span class=p>,</span> <span class=nx>callback</span><span class=p>)</span> <span class=p>{</span>
...
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-11> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-11>&#182;</a> </div> <h3>function addProperties (obj, properties, callback)</h3> <h4>@obj {Object} Object to add properties to</h4> <h4>@properties {Array} List of properties to get values for</h4> <h4>@callback {function} Continuation to pass control to when complete.</h4> <p>Prompts the user for values each of the <code>properties</code> if <code>obj</code> does not already have a value for the property. Responds with the modified object. </p> </td> <td class=code> <div class=highlight><pre><span class=nx>prompt</span><span class=p>.</span><span class=nx>addProperties</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>(</span><span class=nx>obj</span><span class=p>,</span> <span class=nx>properties</span><span class=p>,</span> <span class=nx>callback</span><span class=p>)</span> <span class=p>{</span>
  ...
  <span class=k>return</span> <span class=nx>prompt</span><span class=p>;</span>
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-12> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-12>&#182;</a> </div> <h3>function readLine (callback)</h3> <h4>@callback {function} Continuation to respond to when complete</h4> <p>Gets a single line of input from the user. </p> </td> <td class=code> <div class=highlight><pre><span class=nx>prompt</span><span class=p>.</span><span class=nx>readLine</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>(</span><span class=nx>callback</span><span class=p>)</span> <span class=p>{</span>
  ...
  <span class=k>return</span> <span class=nx>prompt</span><span class=p>;</span>
<span class=p>};</span></pre></div> </td> </tr> <tr id=section-13> <td class=docs> <div class=pilwrap> <a class=pilcrow href=#section-13>&#182;</a> </div> <h3>function readLineHidden (callback)</h3> <h4>@callback {function} Continuation to respond to when complete</h4> <p>Gets a single line of hidden input (i.e. <code>rawMode = true</code>) from the user. </p> </td> <td class=code> <div class=highlight><pre><span class=nx>prompt</span><span class=p>.</span><span class=nx>readLineHidden</span> <span class=o>=</span> <span class=kd>function</span> <span class=p>(</span><span class=nx>callback</span><span class=p>)</span> <span class=p>{</span>
  <span class=kd>var</span> <span class=nx>value</span> <span class=o>=</span> <span class=s1>&#39;&#39;</span><span class=p>,</span> <span class=nx>buffer</span> <span class=o>=</span> <span class=s1>&#39;&#39;</span><span class=p>;</span>
